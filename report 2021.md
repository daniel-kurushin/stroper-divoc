...
![модель основной крышки корпуса](main-case-left.stl.png "модель основной крышки корпуса")

Была создана модель платы корпуса драйвера показанная на рисунке. 

![модель платы корпуса драйвера](camera-cover.stl.png "модель платы корпуса драйвера")

Была разработана модель левого и правого разъема крышки главного корпуса показанная на рисунке. 

![модель левого и правого разъема крышки главного корпуса](camera-holder.stl.png "модель левого и правого разъема крышки главного корпуса")

Была создана модель основного корпуса показанная на рисунке. 

![модель основного корпуса](laser-sensor-holder.stl.png "модель основного корпуса")

Подготовлена модель крышки корпуса драйверов показанная на рисунке. 

![модель крышки корпуса драйверов](main-case-right.stl.png "модель крышки корпуса драйверов")

Подготовлена модель крышки камеры показанная на рисунке. 

![модель крышки камеры](main-case-back.stl.png "модель крышки камеры")

При помощи среды моделирования Blender подготовлена модель торцевого упора y показанная на рисунке. 

![модель торцевого упора y](driver-case-cover.stl.png "модель торцевого упора y")

Была создана модель стойки основного корпуса raspberry pi показанная на рисунке. 

![модель стойки основного корпуса raspberry pi](driver-case-board.stl.png "модель стойки основного корпуса raspberry pi")

При помощи среды моделирования Blender подготовлена модель разъема основного корпуса показанная на рисунке. 

![модель разъема основного корпуса](end-stop-y.stl.png "модель разъема основного корпуса")

модель правой части основного корпуса  показанная на рисунке. 

![модель правой части основного корпуса ](main-case-upper-left-right-corner.stl.png "модель правой части основного корпуса ")

При помощи среды моделирования Blender подготовлена модель задней части основного корпуса показанная на рисунке. 

![модель задней части основного корпуса](end-stop-x.stl.png "модель задней части основного корпуса")

При помощи среды моделирования Blender подготовлена модель верхней части основного корпуса  показанная на рисунке. 

![модель верхней части основного корпуса ](main-case-cover.stl.png "модель верхней части основного корпуса ")

Была создана модель основного корпуса верхний левый правый угол показанная на рисунке. 

![модель основного корпуса верхний левый правый угол](washer.stl.png "модель основного корпуса верхний левый правый угол")

Разработана модель держателя лазерного датчика показанная на рисунке. 

![модель держателя лазерного датчика](end-stop-z.stl.png "модель держателя лазерного датчика")

модель держателя камеры показанная на рисунке. 

![модель держателя камеры](power-supply-holder.stl.png "модель держателя камеры")

При помощи среды моделирования Blender подготовлена модель верхнего разъема основного корпуса показанная на рисунке. 

![модель верхнего разъема основного корпуса](main-case-pi-stand.stl.png "модель верхнего разъема основного корпуса")

Разработана модель держателя блока питания показанная на рисунке. 

![модель держателя блока питания](main-case-cover-left-right-connector.stl.png "модель держателя блока питания")

модель дистанционной шайбы показанная на рисунке. 

![модель дистанционной шайбы](main-case-top.stl.png "модель дистанционной шайбы")

При помощи среды моделирования Blender подготовлена модель торцевого упора оси z показанная на рисунке. 

![модель торцевого упора оси z](main-case-top-connector.stl.png "модель торцевого упора оси z")

Была разработана модель торцевого упора оси x показанная на рисунке. 

![модель торцевого упора оси x](main-case-back-left-right-connector.stl.png "модель торцевого упора оси x")
