...
Микроконтроллер: микросхема, предназначенная для управления объектами, типичный микроконтроллер сочетает в себе функции одного кристалла процессора и периферийных устройств, содержит ОЗУ и ПЗУ.

Образец сыворотки: препараты крови животных или человека, содержащие антитела, используются для диагностики, лечения и профилактики различных заболеваний.
...
SSH: SSH Secure Shell, программный пакет, обеспечивающий безопасное администрирование системы и передачу файлов по незащищенным сетям. 
...
для выявления антител и антигена к SARS-CoV-2.
...
антиген коронавируса SARS-CoV-2 отсутствует в образцах, то тестовая пиния не
